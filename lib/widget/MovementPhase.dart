...
import 'ShootingPhase.dart';
import 'allUnits.dart';

class MovementPhase extends StatefulWidget {
  MovementPhase({super.key, required this.title, required this.settings});
  ...
  String phaseColorString = "Gray";

  @override
  _MovementPhase createState() => _MovementPhase();
}

class _MovementPhase extends State<MovementPhase> {
  @override
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          ElevatedButton(
            ...
            onPressed: () {
              _navigateToShooting(context, widget.settings);
            },
            child: Text("Weiter zur Shooting Phase"),
          ),
          SizedBox(width: 50),
          Text(
            widget.settings.ownPhase
  ...
  void _navigateToShooting(BuildContext context, Settings settings) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) =>
            ShootingPhase(title: "Shootingphase", settings: settings),
      ),
    );
  }
