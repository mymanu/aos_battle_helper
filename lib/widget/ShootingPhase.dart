...
class ShootingPhase extends StatefulWidget {
  ShootingPhase({super.key, required this.title, required this.settings});
  ...
  @override
  _ShootingPhase createState() => _ShootingPhase();
}

class _ShootingPhase extends State<ShootingPhase> {
  @override
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          ElevatedButton(
            ...
            onPressed: () {
              _navigateToCharge(context, widget.settings);
            },
  ...
  void _navigateToCharge(BuildContext context, Settings settings) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) =>
            ChargePhase(title: "Chargephase", settings: settings),
      ),
    );
  }
