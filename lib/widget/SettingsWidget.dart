...
class _SettingsWidget extends State<SettingsWidget> {
  ...
  void pickSeraphonHardcoded() {
    ...
    Weapon hooves = Weapon("hooves", "Ghyranite Steed`s Teeth, Hooves or Claws");
    hooves.attack = "2";
    hooves.hit = "5+";
    hooves.wound = "3+";
    hooves.damage = "1";
    ...
    Unit slannSolo = Unit.withSpells("Slann Solo - schneller als ein Skink", slannSoloSpells);
    ...
    Unit saurusWarriors = Unit.withSpells("Saurus Warriors", saurusWarriorsSpells);
    ...
    saurusWarriors.keywords = "Order, Seraphon, Saurus, Infantry, Champion, Standard Bearer, Musician";
    ...
    Unit skinkStarpriest = Unit.withSpells("Skink Starpriest", skinkStarpriestSpells);
    ...
    skinkStarpriest.keywords = "Regimental Leader, Hero, Order, Seraphon, Skink, Wizard (1), Infantry";
    ...
    Weapon handlersJavelins = Weapon("handlersJavelins", "Handlers`Meteoric Javelins");
    ...
    Unit realmshaperEngine = Unit.withSpells("Realmshaper Engine", realmshaperEngineSpells);
    ...
    furtherTheGreatPlan.timing = "Once Per Battle, Start of the Third Battle Round";
    ...
    itzlTheTamer.details = "Companion weapons used by friendly Seraphon units have Crit (2 Hits).";
    ...
    quetzlThePreserver.details = "Subtract 1 from the Rend characteristic of melee weapons for attacks that target friendly Seraphon units that are wholly within friendly territory.";
    ...
    sotekTheDeliverer.details = "Add 2 to the Move characteristic of friendly Seraphon units.";
    ...
    tepokTheSeer.details = "Add 1 to casting rolls for friendly Seraphon units.";
  ...
  void pickWarpsparkClawpack() {
    ...
    Weapon warpLightningBlast = Weapon("warpLightningBlast", "Warp Lightning Blast");
    ...
    Unit warpLightningCannon = Unit.withSpells("Warp Lightning Cannon", warpLightningCannonSpells);
    ...
    endlessSwarmofRats.details = "Effect: When a friendly Clanrats unit uses its `Seething Swarm` ability, you can return D6 slain"
    "models to that unit instead of D3.";

    Ability warpstoneLacedArmour = Ability("Warpstone-laced Armour");
    warpstoneLacedArmour.timing = "Once Per Battle, Reaction: Opponent declared an ATTACK ability and targeted your Stormfiends unit";
    warpstoneLacedArmour.color = "Red";
    warpstoneLacedArmour.details = "Used By: Your Stormfiends unit."
